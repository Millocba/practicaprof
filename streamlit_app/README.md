...
| Perfil de fuentes | `pages/04_perfil_de_fuentes.py` | Perfil agregado de archivos CSV o Excel (solo con la app en la máquina local; se leen en memoria y no se guardan), comparación de un perfil con los datos sintéticos y su informe de brechas, y aprobación de perfiles pendientes. Ver [perfiles/README.md](../perfiles/README.md) |

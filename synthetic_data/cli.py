...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--devices", type=int, default=700)
    parser.add_argument("--people", type=int, default=2_000)
    parser.add_argument("--telemetry-events", type=int, default=100_000)
    parser.add_argument("--fuel-transactions", type=int, default=50_000)
